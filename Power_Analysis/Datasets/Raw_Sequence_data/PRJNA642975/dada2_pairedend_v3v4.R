...
#SRR12999945 no filter

head(out)

# Step 1: Call the pdf command to start the plot
png(file = "~/Documents/Microbiome_data/PRJNA642975/QualityPlot_afterTrim.png",   # The directory you want to save the file in
...
png(file = "~/Documents/Microbiome_data/PRJNA642975/error_plot.png",   # The directory you want to save the file in
    width = 4, # The width of the plot in inches
    height = 4)
...
write.csv(nonchim, "Bimera_output_PRJNA642975.csv")
...
head(track)
write.csv(track, "read_track_PRJNA642975.csv")
...
write.csv(taxa_silva, "taxa_silva132_v4_PRJNA642975.csv")
saveRDS(taxa_silva, "taxa_silva132_v4_PRJNA642975.rds")

#unname(head(taxa_gg))
unname(head(taxa_silva))

#write to disk
write.csv(seqtab.nochim, "seqtab_nochim_v4_PRJNA642975.csv")
saveRDS(seqtab.nochim, "seqtab_nochim_v4_PRJNA642975.rds")
seqtab.nochim.trans = t(seqtab.nochim)
write.csv(seqtab.nochim.trans, "seqtab_nochim_transposed_v4_PRJNA642975.csv")
