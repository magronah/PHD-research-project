...
write.csv(nonchim, "Bimera_output_PRJNA624252.csv")
...
head(track)
write.csv(track, "read_track_PRJNA624252.csv")
...
write.csv(taxa_silva, "taxa_silva132_v3v4_PRJNA624252.csv")
saveRDS(taxa_silva, "taxa_silva132_v3v4_PRJNA624252.rds")

#unname(head(taxa_gg))
unname(head(taxa_silva))

#write to disk
write.csv(seqtab.nochim, "seqtab_nochim_v3v4_PRJNA624252.csv")
saveRDS(seqtab.nochim, "seqtab_nochim_v3v4_PRJNA624252.rds")
seqtab.nochim.trans = t(seqtab.nochim)
write.csv(seqtab.nochim.trans, "seqtab_nochim_transposed_v3v4_PRJNA624252.csv")
