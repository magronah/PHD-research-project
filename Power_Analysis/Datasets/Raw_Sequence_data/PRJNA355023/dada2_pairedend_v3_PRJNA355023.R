...
write.csv(nonchim, "Bimera_output_PRJNA355023.csv")
...
head(track)
write.csv(track, "read_track_PRJNA355023.csv")
...
write.csv(taxa_silva,"taxa_silva132_v3_PRJNA355023.csv")
saveRDS(taxa_silva, "taxa_silva132_v3_PRJNA355023.rds")

#unname(head(taxa_gg))
unname(head(taxa_silva))

#write to disk
write.csv(seqtab.nochim, "seqtab_nochim_v3_PRJNA355023.csv")
saveRDS(seqtab.nochim, "seqtab_nochim_v3_PRJNA355023.rds")
seqtab.nochim.trans = t(seqtab.nochim)
write.csv(seqtab.nochim.trans, "seqtab_nochim_transposed_v3_PRJNA355023.csv")
